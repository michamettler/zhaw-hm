...
data = np.array([
    ...
    [60.00, 61.00, 4.02, 3.89, 33.00],
    [60.00, 62.00, 4.02, 4.02, 37.00],
...
plt.plot(x_data, y_data, marker='o', color='black', linestyle='', label='Messwerte m_CH')
y_fit = A @ lam_qr
